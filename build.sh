...
mkdir -p bin build build/idt build/memory build/memory/heap build/memory/paging build/io build/disk build/string build/fs build/fs/fat build/gdt build/task build/isr80h
