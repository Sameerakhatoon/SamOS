...
mkdir -p bin build build/string build/memory build/memory/heap build/memory/paging build/io build/idt build/task build/fs build/fs/fat build/disk build/gdt
