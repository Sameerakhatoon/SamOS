#ifndef KERNEL_PCI_H
#define KERNEL_PCI_H
// Lecture 177 - PCI configuration-space layout, BAR + device
// records, and the API the L178-L181 source files implement.
...
#define PCI_HEADER_PROG_IF_OFFSET           0x09  // Programming interfac e8 bits (sic)
...
#define PCI_HEADER_BAR0_OFFSET              0x10
#define PCI_HEADER_BAR1_OFFSET              0x14
...
// Lecture 177 - upstream macros. PCI_BASE_CLASS forgets the
// `func` arg in the cfg-read call. PCI_BASE_SUBCLASS supplies
// it. Preserved verbatim per the project rule on upstream
...
// PCI Express ECAM range descriptor.
