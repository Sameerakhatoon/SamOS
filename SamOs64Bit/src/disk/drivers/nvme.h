...
// Lecture 190 - NVME driver register layout, queue entries,
// and per-disk private data. L192-L195 land the source.
...
// Lecture 190 - upstream wrote this macro with a trailing space
// after the line-continuation backslash, which gcc rejects.
// SamOs drops the trailing whitespace so the file compiles
// while keeping the macro shape.
