...
// Lecture 137 - PS/2 mouse driver. Port constants and the
// per-instance bookkeeping struct. ps2_mouse_get() returns a
// pointer to the static `struct mouse` so the mouse system
// (L132) can mouse_register it.
