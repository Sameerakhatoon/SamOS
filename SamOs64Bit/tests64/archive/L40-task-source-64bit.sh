#!/bin/bash
# tests64/L40-task-source-64bit.sh
#
# Lecture 40 - task.c / task.h widened for 64-bit. task.c not
# yet in the build; L45 wires it in after L41/L42/L43/L44 land
# the dependencies (process, paging_desc_free, kernel_desc).
#
# Smoke tokens identical to L38 / L39.
