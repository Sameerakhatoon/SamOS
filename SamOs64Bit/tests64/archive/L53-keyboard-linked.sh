#!/bin/bash
# tests64/L53-keyboard-linked.sh
#
# Lecture 53 - keyboard linked into the build.
#
# keyboard.o + classic.o added to FILES. Nothing in kernel_main
# calls keyboard_init yet; the test just confirms the link
# works. Tokens unchanged from L50..L52.
