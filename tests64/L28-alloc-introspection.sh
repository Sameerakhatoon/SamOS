#!/bin/bash
# tests64/L28-alloc-introspection.sh
#
# Lecture 28 - multiheap_allocation_block_count + byte_count,
# helpers for routing a (possibly-virtual) pointer back to the
# owning heap.
#
# All new symbols are dormant at L28; runtime tokens match the
# L23..L27 series.
